...
public class ReflectionUtils {
    ...
    public static Field getAccessibleField(Object obj, String fieldName) {
        ...
        while(superClass != Object.class) {
            try {
                Field var4 = superClass.getDeclaredField(fieldName);
    ...
    public static Method getAccessibleMethod(Object obj, String methodName, Class... parameterTypes) {
        ...
        while(superClass != Object.class) {
            try {
                Method var5 = superClass.getDeclaredMethod(methodName, parameterTypes);
                var5.setAccessible(true);
                return var5;
            } catch (NoSuchMethodException var51) {
                superClass = superClass.getSuperclass();
            }
        }
    ...
    public static Object instance(String className) {
        try {
            Class var4 = Class.forName(className);
